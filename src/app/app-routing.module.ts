...
const routes: Routes = [
  {
    path: '',
    redirectTo:
      '/home/(homeRouterOutlet:home//catalogRouterOutlet:catalog//favoritesRouterOutlet:favorites//settingsRouterOutlet:settings)',
    pathMatch: 'full',
  },
  {
    path: 'home',
    ...
    children: [
      { path: 'home', component: HomeComponent, outlet: 'homeRouterOutlet' },
      {
        ...
        outlet: 'catalogRouterOutlet',
      },
      {
        path: 'favorites',
        component: FavoritesComponent,
        outlet: 'favoritesRouterOutlet',
      },
      {
        path: 'settings',
